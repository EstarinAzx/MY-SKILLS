...
**3. Standalone skills** (`~/.claude/skills/`) — [[design-skills]] (impeccable-led family), [[llm-kb]] (knowledge vaults, built this one), [[context-handoff]] (.context/ per-project handoff), [[grill-skills]] → [[github-planning]] (plan → PRD → issues chain), [[improve-codebase-architecture]], [[mcp-tooling]] (Unity MCP + mcp2cli), [[bugs-begone]], [[output-skill]], [[preset]], [[read-flow]].
